    ...
    def update(self, i_epoch, batch):
        for nabla, theta, delta_theta in zip(self.nablas, self.thetas,
            ...
            def _(base, size):
                ...
                red_old = self.momentum * old  # momentum*delta_theta
                rate = self.gamma.expand_to_vector(size) # create vector with n values(size) using gamma
                ...
                pre_trunc = nabla_vector.v * rate.v # nabla * learning_rate
